...
const SECTORS: Sector[] = [
  {
    ...
    color: "#7A4FD9",
    variant: "candlestick",
    desc: "Dark trading screen. Candlesticks populate left→right, crosshair lands on last close, panel slides off.",
  },
  {
    name: "Real Estate",
    color: "#8C6A2A",
  ...
  },
  {
    ...
    color: "#244B4F",
    variant: "ekg-monitor",
    desc: "Black overlay, ECG trace draws across with synced vitals (HR, SpO₂, BP, Resp).",
  },
  {
    name: "Media & Consumer",
    color: "#3B4230",
    variant: "theater-curtains",
    desc: "Heavy velvet drapes meet in the center under a gold-trimmed proscenium valance, then part.",
  },
];
    ...
    <div className="relative min-h-screen bg-ink px-8 py-12 text-paper md:px-12">
      <div className="mx-auto max-w-[900px]">
        ...
        <p className="mt-3 max-w-[58ch] font-sans text-[14px] leading-[1.6] text-paper/65">
          Click any sector to play the full cover &rarr; hold &rarr; uncover
          sequence. The route doesn&rsquo;t change &mdash; you stay on this
          page and can replay as often as you like.
        </p>
